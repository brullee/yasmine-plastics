...
export function WhatsAppFAB({ locale }: { locale: string }) {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-4 right-6 rtl:right-auto rtl:left-6 z-50 flex items-center gap-2.5 bg-brand-navy text-white p-3 sm:px-5 sm:py-3 rounded-full shadow-lg hover:bg-blue-900 dark:bg-blue-900 dark:hover:bg-blue-800"
    >
